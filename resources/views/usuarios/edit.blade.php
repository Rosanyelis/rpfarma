    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form method="POST" action="{{ url('/usuarios/'.$data->id.'/actualizar-usuario') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_completo"
                                                ...
                                                placeholder="Ejm: Jon Doe" value="{{ $data->nombre_completo }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control @if ($errors->has('name')) is-invalid @endif"
                                                id="usuarios" placeholder="Ejm: Jon Laboratorio" value="{{ $data->name }}">
                                            @if ($errors->has('name'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('name') }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control @if ($errors->has('email')) is-invalid @endif"
                                                id="emailInput" placeholder="Ejm: JonDoe@example.com" value="{{ $data->email }}">
                                            @if ($errors->has('email'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('email') }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rol_id" class="form-control @if ($errors->has('rol_id')) is-invalid @endif">
                                                ...
                                                @foreach ($rols as $item)
                                                    <option value="{{ $item->id }}" @if ($item->id == $data->rol_id) selected @endif >{{ $item->descripcion }}</option>
                                                @endforeach
                                            </select>
